//import { parseRangeHeader } from '@subzerocloud/nodejs'
...
export function getEmployees(offset: number, limit: number) {
    return useSWR<any>([`${apiBaseUrl}/Employees?select=EmployeeID,Name:$concat(FirstName, LastName),Title,Address,City,Country&limit=${limit}&offset=${offset}`, common_options], fetcher)
}
