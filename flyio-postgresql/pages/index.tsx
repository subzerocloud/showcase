    ...
    return (
        <div className="px-8 mt-5">
            ...
            <div className="mx-auto py-4 text-base card-content">
                ...
                <h2 className='text-xl text-gray-400 mb-5'>Running on Fly.io and PostgreSql</h2>
                ...
                <p className='pt-4'>You can see the <a className='link' href='https://github.com/subzerocloud/showcase/tree/main/flyio-postgresql'>source code</a> and additional implementation details on Github</p>
                ...
                <ul>
                    ...
                    <li className='pt-4'>Data is stored in a PostgreSql database</li>
                    <li className='pt-4'>Everything is deployed to <a href="https://fly.io/" className='link'>Fly.io</a></li>
                </ul>
